...
GM.Strings = {
	...
	de = { --Translation by http://steamcommunity.com/id/aqualion
	       sg = "Sicherheitsbeamte",
               animatronics = "Animatronics",
               animatronic = "Animatronic",
               tonight = "Nacht",
               night = "Nacht",
               startanimatronics = "Der Strom ist an",
               foxy = "Foxy",
               freddy = "Freddy",
               chica = "Chica",
               bonnie = "Bonnie",
               goldenfreddy = "Golden Freddy",
               unassigned_SGvsA = "Wähle dein Team",
               powerleft = "Energie verbleibend:",
               usage = "Nutzung:",
               unassigned_powerdown = "Du kannst nicht beitreten wenn der Strom verbraucht ist!",
               flashlight = "Taschenlampe",
               monitor = "Monitor",
               monitor_inst = "Rechtsklick um den Monitor zu öffnen. Linksklick um die Knöpfe zu benutzen. R um in die FNaF Ansicht zu gelangen.",
               monitor_purp = "Zeigt das Restaurant per Kamera.",
               spectator = "Zuschauer",
               warn_css = "Counter Strike: Source ist nicht aktiviert. Dir werden Texturen fehlen und du wirst ERRORS bekommen.",
               links = "Link(s)",
               faqbtn = "FAQ",
               config = "Konfiguration",
               hidever = "Version verstecken",
               dhud = "HUD anzeigen (Achtung! Das ist eine Garry's Mod convar)",
               infoat = "Informationen/Misc",
               lang = "Sprache",
               changemap = "Karte tauschen",
               resetsave = "Speicherstand zurücksetzen",
               debugmenu = "Debug Menü (nur zum Debuggen)",
               start = "Start",
               stop = "Stop/Neustarten",
               reset = "Resetten",
               autofnafview = "FNaF Ansicht automatisch aktivieren",
               exitfnafview = "FNaF Ansicht verlassen",
               refreshbypass = "Umgebung aktualisieren",
               chatsound = "Chat Ton",
               flashwindow = "Fenster flackern lassen bei Benachrichtigungen (nur Windows)",
               password = "Passwort",
               saveserver = "Speichere deinen Fortschritt auf dem Server",
               progressinfo = "Letzte gespeicherte Nacht",
               disablexpsc = "Xperidia's Vorstellung deaktivieren",
               disablehalo = "Schimmern deaktivieren (Verbessert Leistung)",
               nightwillstart = "Die Nacht startet in",
               togglesgvsa = "SBvsA umstellen",
               now_sgvsa = "Das Spiel ist nun im PvP SBvsA Modus!",
               now_normal = "Das Spiel ist nun im Normalen Modus!",
               nosp = "Nicht im Einzelspieler!",
               nosg = "Es gibt keine Sicherheitsbeamten!",
               gamebeenreset = "Das Spiel wurde zurückgesetzt!",
               notsgvsa = "Du bist nicht im SBvsA Modus!",
               warn_font = "Der Spielmodus ist nicht installiert! Schriftarten werden fehlen!",
               selectplayermodelbtn = "Spielermodell wählen"
	}
}
